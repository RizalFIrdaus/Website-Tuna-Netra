    ...
    <div class="container">
      <div class="row">
        <div class="col-lg mt-5 d-flex justify-content-between">
          <div class="head">     
            <div class="headlink">Materi / Organ Pernapasan pada Manusia</div>
            <div class="decs">Sistem Pernapasan Manusia</div>
          </div>
         <div class="img-logo">
      ...
      <div class="row">
                    ...
                    <div class="jumbotron jumbotron-fluid">
                        <div class="container py-5">
                           <div class="main-content">
                               <div class="judul">
                                   <h3>Pengertian Sistem Pernapasan</h3>
                               </div>
                               <img src="{{asset('/img/respirasiumum.png')}}" alt="" width="1000px">
                               <div class="text py-4 font-weight-bolder" style="line-height: 40px;">  
                                Setiap makhluk hidup pasti bernafas. Bernafas adalah proses menghirup dan mengeluarkan udara. Saat manusia bernafas,manusia menghirup oksigen atau O2 dan mengeluarkan karbondioksida atau CO2. Organ pernafasan atau alat pernafasan manusia terdiri dari hidung,tenggorokan dan paru-paru. 
                               </div>
                           </div>
                        </div>
                      </div>
                        ...
                        <div class="container py-5">
                           <div class="main-content">
                               ...
                               <div class="ratio ratio-16x9">
                                <iframe
                                  src="https://www.youtube.com/embed/2-Ird31S9j4"
                                  title="YouTube video"
                                  allowfullscreen
                                ></iframe>
                              </div>
        ...
        <div class="col-md-12 d-flex justify-content-between pt-3 pb-5">
          ...
          <a href="/materi/alatpernapasan/hidung" class="btn btn-success">Lanjut</a>
        </div>
      </div>
    </div>
  </div>
