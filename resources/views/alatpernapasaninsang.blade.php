    ...
    <div class="container">
      <div class="row">
        <div class="col-lg mt-5 d-flex justify-content-between">
          <div class="head">     
            <div class="headlink">Materi / Organ Penapasan / Insang</div>
                    ...
                    <div class="jumbotron jumbotron-fluid">
                        <div class="container py-5">
                           <div class="main-content">
                               <img  src="{{asset('/img/insang.jpg')}}" alt="" width="450px">
                               <div class="text py-4 font-weight-bolder" style="line-height: 40px">
                              Pernapasan insang ikan hidup di air ,   <span class="pengertian">ikan bernafas dengan insang </span>. Jumlah insang ikan ada empat pasang. Insang terletak disebelah kanan dan kiri kepala. Insang dilindungi oleh tutup insang. Proses pernafasan ikan adalah Saat mulut ikan terbuka, air masuk kedalam rongga mulut dan tutup insang akan tertutup. Kemudian, oksigen yang terkandung dalam air di ikat oleh kapiler darah, lalu karbondioksida akan dikeluarkan melewati insang. 
                               </div>
                           </div>
                        </div>
                      </div>
